...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    /** EditText field to enter the sock availibility of the item */
    private Spinner mInStockSpinner;

    private int mInStock=SaleEntry.NOT_IN_STOCK;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQuantityEditText = (EditText) findViewById(R.id.edit_unit_pieces);
        mInStockSpinner = (Spinner) findViewById(R.id.spinner_stock);
        ...
        mInStockSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.category_in_stock))) {
                        mInStock = SaleEntry.IN_STOCK;
                    } else if (selection.equals(getString(R.string.category_not_in_stock))) {
                        mInStock = SaleEntry.NOT_IN_STOCK;
                    } else {
                        mInStock = SaleEntry.NOT_IN_STOCK;
                    }
                }
...
//                && mGender == PetEntry.GENDER_UNKNOWN
        ...
        values.put(SaleEntry.COLUMN_ITEM_NAME, nameString);
        values.put(SaleEntry.COLUMN_ITEM_DESCRIPTION, descriptionString);
        values.put(SaleEntry.COLUMN_ITEM_IN_STOCK, mInStock);
        ...
        values.put(SaleEntry.COLUMN_ITEM_QUANTITY, quantity);
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        String[] projection = {
                ...
                SaleEntry.COLUMN_ITEM_IN_STOCK,
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int inStockColumnIndex = cursor.getColumnIndex(SaleEntry.COLUMN_ITEM_IN_STOCK);
            ...
            switch (inStock) {
                case SaleEntry.IN_STOCK:
                    mInStockSpinner.setSelection(1);
                    break;
                case SaleEntry.NOT_IN_STOCK:
    ...
    public void onLoaderReset(Loader<Cursor> loader) {
        ...
        mInStockSpinner.setSelection(0); // Select "Unknown" gender
    }
}